...
a novel multithreaded model which isolates memory between threads by default and provides a higher level abstraction for scalable MapReduce communication between threads – \myth (Scalable Thread).
