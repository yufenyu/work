...
Since Phoenix is sensitive to memory allocator\cite{yoo2009phoenix2}, we firstly evaluate its scalability with jemalloc, a good scalable memory allocator.
