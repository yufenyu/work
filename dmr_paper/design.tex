...
\bluet{That means Phoenix waster most of time to wait but not actual work.
And it can't fully use mulitcores resource.
From Seciton2.2 we know, Phoenix takes two strategies to avoid multiple threads operate the global buffer concurrently.
Why the benchmarks suffer from serious lock contention?
Actually, it caused by linux kernel.}
\begin{figure}[!h!t]  
    \centering
