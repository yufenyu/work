...
The \codet{mmap} operation creates memory mapping regions and adds them to the region red-back tree in Linux. 
...
\redt{Although mmap() system call in applications will not cause contention,
