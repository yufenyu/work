...
Then, we propose a novel multithreaded model --\myth (Scalable Thread), which isolates memory between threads by default and provides an unbundary-channel for communicating between threads.
